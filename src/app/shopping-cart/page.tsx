			...
			<div className='mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0'>
					...
					{products.map(product => (
							...
							<div className='sm:ml-4 sm:flex sm:w-full gap-x-4 sm:justify-between'>
								...
								<div className='mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6'>
									<div className='flex items-center border-gray-100'>
										<span className='cursor-pointer rounded-l bg-gray-600 py-1 px-3.5 duration-100 hover:bg-blue-500 hover:text-blue-50' onClick={()=>{
                      handleDecrement(product.id)
										...
										<input
											...
											min='1'
										/>
										<span className='cursor-pointer rounded-r bg-gray-600 py-1 px-3 duration-100 hover:bg-blue-500 hover:text-blue-50' onClick={()=>{
				...
				<div className='mt-6 h-full rounded-lg border bg-gray-800 p-6 shadow-md md:mt-0 md:w-1/3'>
					<div className='mb-2 flex justify-between'>
						...
						<p className='text-gray-100'>$129.99</p>
					</div>
					<div className='flex justify-between'>
						<p className='text-gray-100'>Shipping</p>
						<p className='text-gray-100'>$4.99</p>
					</div>
					<hr className='my-4' />
					<div className='flex justify-between'>
